...
def verify_internal_or_user(
    ...
    """
    Authenticate inter-service requests via X-Internal-Service-Token or user JWT Bearer token.
    Enforces authentication for Inventory endpoints used by Order Service.
    """
